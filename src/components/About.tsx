        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-white/70">
              Étudiant en troisième année de Bachelor Développeur Web à <strong className="text-portfolio-primary"><a href="https://www.hetic.net/?gge_source=google&gge_medium=cpc&gge_term=hetic&gge_campaign=Search-MarquePure&gad_source=1&gad_campaignid=81530319&gbraid=0AAAAAD8alhHNibzQrZyN69AfRS63mvW9g&gclid=Cj0KCQjw_8rBBhCFARIsAJrc9yCLjb9kSASAQ232gqMoC71TOwGQYYEVjwywdJE6VJt975HygNkgc8AaAgzLEALw_wcB">HETIC</a></strong>, je me spécialise dans le développement frontend avec une forte appétence pour React.
            </p>
            <p className="text-white/70">
